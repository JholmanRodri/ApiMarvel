...
const usuarioPost=async(req,res)=>{
    ...
    const usuario = new Usuario ({nombre,apellidos,email,password,documento})
...
export {usuarioPost,usuarioPutdatos,usuarioPutActivar,usuarioPutDesactivar,cargarArchivoCloudPut,usuarioLogin,mostrarImagenCloud,usuarioGetListarid,usuarioGetListarNombre}